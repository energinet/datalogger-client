    ...
    initElement: function(el) {
      if (!el.getContext) {
        ...
        if (attrs.width && attrs.width.specified) {
          // TOmDO : use runtimeStyle and coordsize
        ...
        if (attrs.height && attrs.height.specified) {
          // TO DO: use runtimeStyle and coordsize
...
//   *
  ...
  contextPrototype.beginPath = function() {
    // TO DO: Branch current matrix so that save/restore has no effect
    //       as per safari docs.
    this.currentPath_ = [];
  };
  ...
  contextPrototype.stroke = function(aFill) {
    ...
    for (var i = 0; i < this.currentPath_.length; i++) {
      ...
      // TO DO: Following is broken for curves due to
    ...
    if (!aFill) {
      ...
      if (ws && hs) {
        ...
        lineStr.push('<g_vml_:fill',
                     ...
                     ' type="tile"',
                     // TO DO: Figure out the correct size to fit the scale.
                     //' size="', w, 'px ', h, 'px"',
...
//   *
  contextPrototype.drawText_ = function(text, x, y, maxWidth, stroke) {
  	//alert("drawText_:" + text + ": "+x+","+y+" maxWidth:" +  maxWidth);
  ...
  contextPrototype.fillText = function(text, x, y, maxWidth) {
    this.drawText_(text, x, y+2, maxWidth, false);
  };

  contextPrototype.strokeText = function(text, x, y, maxWidth) {
    this.drawText_(text, x, y+2, maxWidth, true);
  };
