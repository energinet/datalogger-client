...
enum module_types {
	MTYPE_INPUT, MTYPE_OUTPUT, MTYPE_CONTROL, MTYPE_DATALOG,
};
...
enum module_subtypes {
	SUBTYPE_FLOW, SUBTYPE_LEVEL, SUBTYPE_EVENT, SUBTYPE_NONE,
};
...
struct module_type {
	...
	struct event_handler *(*subscribe)(struct module_base *base,
