...
#define MW_FREE_LIST    128      /* (min 4) number of free()'s to track */
...
#define xmpp_alloc(x,n)       mwMalloc(n,__FILE__,__LINE__)
#define xmpp_strdup(x,p)       mwStrdup(p,__FILE__,__LINE__)
#define xmpp_realloc(x,p,n)    mwRealloc(p,n,__FILE__,__LINE__)
#define calloc(n,m)     mwCalloc(n,m,__FILE__,__LINE__)
#define xmpp_free(x,p)         mwFree(p,__FILE__,__LINE__)
